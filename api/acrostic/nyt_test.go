...
func TestParseXWordInfoPuzzleResponse(t *testing.T) {
	tests := []struct {
		...
		{
			name:  "givens",
			input: load(t, "xwordinfo-nyt-20011007-given-cell.json"),
			verify: func(t *testing.T, puzzle *Puzzle) {
				expected := [][]string{
					{"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
					{"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
				...
				assert.Equal(t, expected, puzzle.Givens)
			},
		},
		{
			name:  "blocks",
		...
		{
			name:  "cell clue letters (with givens)",
			input: load(t, "xwordinfo-nyt-20011007-given-cell.json"),
			verify: func(t *testing.T, puzzle *Puzzle) {
				expected := [][]string{
					{"G", "Z", "T", "", "K", "B", "O", "E", "Q", "F", "", "S", "X", "U", "I", "W", "V", "", "C", "L", "", "P", "", "X", "D", "V", "M"},
					{"Z", "U", "A", "H", "Y", "", "G", "R", "", "F", "I", "W", "E", "X", "", "K", "A", "N", "B", "H", "", "F", "S", "G", "", "Z", "R"},
					{"W", "D", "X", "N", "E", "Y", "", "B", "G", "", "K", "J", "L", "", "U", "Z", "M", "D", "E", "X", "Y", "N", "Q", "P", "", "H", "W"},
					{"M", "X", "J", "I", "Y", "D", "", "G", "N", "C", "", "Z", "Q", "D", "F", "H", "A", "", "R", "U", "M", "Q", "V", "Y", "X", "", "B"},
					{"E", "S", "F", "T", "", "Q", "O", "", "M", "X", "J", "F", "V", "D", "A", "", "E", "T", "P", "", "Z", "", "U", "B", "Y", "", "H"},
					{"", "O", "Z", "W", "A", "U", "", "C", "T", "R", "", "A", "K", "", "W", "M", "Z", "E", "", "N", "H", "P", "L", "Y", "V", "F", "U"},
					{"R", "X", "Q", "S", "D", "", "B", "H", "T", "", "N", "X", "M", "J", "Y", "D", "U", "L", "", "P", "W", "K", "M", "", "O", "R", "Q"},
					{"S", "", "V", "Z", "P", "D", "T", "N", "X", "Y", "", "J", "K", "", "O", "", "I", "S", "C", "", "V", "", "", "", "", "", ""},
				}
				assert.Equal(t, expected, puzzle.CellClueLetters)
			},
		},
